...
run-web-server:
	docker run -d -name web_server -link postgresql_server:DB -link elasticsearch_server:ES -p 8082:80 -e POSTGRESQL_USER=${POSTGRESQL_USER} -e POSTGRESQL_PASS=${POSTGRESQL_PASS} -e POSTGRESQL_DB=${POSTGRESQL_DB} web_server_image 
