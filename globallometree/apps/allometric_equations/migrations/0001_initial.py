    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Allometric_equation_ID', models.AutoField(serialize=False, primary_key=True, db_column=b'allometric_equation_id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('Created', models.DateTimeField(auto_now_add=True, db_column=b'created')),
                ('Modified', models.DateTimeField(auto_now=True, verbose_name=b'Last modified', db_column=b'modified')),
                ('Population_ID', models.AutoField(serialize=False, primary_key=True, db_column=b'population_id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('Created', models.DateTimeField(auto_now_add=True, db_column=b'created')),
                ('Modified', models.DateTimeField(auto_now=True, verbose_name=b'Last modified', db_column=b'modified')),
                ('Tree_type_ID', models.AutoField(serialize=False, primary_key=True, db_column=b'tree_type_id')),
                ('Name', models.CharField(max_length=255, null=True, db_column=b'name', blank=True)),
            ],
            options={
                'ordering': ('Name',),
        ...
        migrations.AddField(
            ...
            name='Population',
            field=models.ForeignKey(db_column=b'population_id', blank=True, to='allometric_equations.Population', null=True),
        ),
        migrations.AddField(
            model_name='allometricequation',
            name='Reference',
            field=models.ForeignKey(db_column=b'reference_id', blank=True, to='source.Reference', null=True),
        ),
        migrations.AddField(
            model_name='allometricequation',
            name='Species_group',
            field=models.ForeignKey(db_column=b'species_group_id', blank=True, to='taxonomy.SpeciesGroup', null=True),
        ),
        migrations.AddField(
            model_name='allometricequation',
            name='Tree_type',
            field=models.ForeignKey(db_column=b'tree_type_id', blank=True, to='allometric_equations.TreeType', null=True),
        ),
    ]
