    ...
    def get_mapping(cls):
        ...
        mapping = {
            "properties": {
                    ...
                    "Bd": estype_boolean,
                    "Bg": estype_boolean,
                    "Bias_correction": estype_string_not_analyzed,
                    "Bt": estype_boolean,
                    "Contributor": estype_long,
                    ...
                    "Max_X": estype_string_not_analyzed,
                    "Min_X": estype_string_not_analyzed,
                    "Output": estype_string_not_analyzed,
                    "Output_TR": estype_string_not_analyzed,
                    "Population": estype_long,
                    "R2": estype_string_not_analyzed,
                    "Rb": estype_boolean,
                    ...
                    "Stump_height": estype_string_not_analyzed,
