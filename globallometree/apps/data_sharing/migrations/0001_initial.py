    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Data_license_ID', models.AutoField(serialize=False, primary_key=True, db_column=b'data_license_id')),
                ...
                ('Available_to_registered_users', models.BooleanField(default=False, help_text=b'Is this license granted to all registered globallometree users?', db_column=b'available_to_registered_users')),
                ...
                ('Restrict_resell', models.BooleanField(default=False, help_text=b"The Data User shall not sell, market, rent, lease, sublicense, lend, assign, time-share, distribute, disseminate or transfer, in whole or in part, the Raw Data, any updates, or end user's rights under this Agreement.", db_column=b'restrict_resell')),
                ('Restrict_duplication', models.BooleanField(default=False, help_text=b"The Data User shall not duplicate the Data Provider's proprietary and copyright-protected Raw Data or attempt to do so by altering, decompiling, or disassembling the Raw Data.", db_column=b'restrict_duplication')),
                ...
                ('Restrict_attributed_ownership', models.BooleanField(default=False, help_text=b'The Data Provider shall be acknowledged as the data source. If changes are made to the Raw Data, attribution should be given to the Data Provider as owner of the Raw Data.', db_column=b'restrict_attributed_ownership')),
                ...
                ('Expires', models.CharField(default=b'on_activity_completion', max_length=100, db_column=b'expires', choices=[(b'on_activity_completion', b'When Data User has completed the activities for which the Raw Data were provided.'), (b'on_three_months_notice', b'If either Party terminates this Agreement by notifying the other by email of its intent to terminate at least three months in advance of the effective date of termination, and indicating such termination date.'), (b'on_date', b'On the indicated date'), (b'none', b'No expiry')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('Created', models.DateTimeField(auto_now_add=True, db_column=b'created')),
                ('Modified', models.DateTimeField(auto_now=True, verbose_name=b'Last modified', db_column=b'modified')),
                ('Dataset_ID', models.AutoField(serialize=False, primary_key=True, db_column=b'dataset_id')),
                ...
                ('Data_license', models.ForeignKey(db_column=b'data_license_id', verbose_name=b'License', to='data_sharing.DataLicense')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('Created', models.DateTimeField(auto_now_add=True, db_column=b'created')),
                ('Modified', models.DateTimeField(auto_now=True, verbose_name=b'Last modified', db_column=b'modified')),
                ('Data_sharing_agreement_ID', models.AutoField(serialize=False, primary_key=True, db_column=b'data_sharing_agreement_id')),
                ...
                ('Dataset', models.ForeignKey(to='data_sharing.Dataset', db_column=b'dataset_id')),
