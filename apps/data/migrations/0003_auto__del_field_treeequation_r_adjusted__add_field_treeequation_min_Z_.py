...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TreeEquation.r_adjusted'
        db.delete_column('data_treeequation', 'r_adjusted')

        # Adding field 'TreeEquation.min_Z'
        db.add_column('data_treeequation', 'min_Z',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True),
                      keep_default=False)

        # Adding field 'TreeEquation.max_Z'
        db.add_column('data_treeequation', 'max_Z',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True),
                      keep_default=False)

        # Adding field 'TreeEquation.family'
        db.add_column('data_treeequation', 'family',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TreeEquation.r2_adjusted'
        db.add_column('data_treeequation', 'r2_adjusted',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=5, blank=True),
                      keep_default=False)

        # Adding field 'TreeEquation.sample_size'
        db.add_column('data_treeequation', 'sample_size',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'TreeEquation.species'
        db.alter_column('data_treeequation', 'species', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TreeEquation.genus'
        db.alter_column('data_treeequation', 'genus', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Adding field 'TreeEquation.r_adjusted'
        db.add_column('data_treeequation', 'r_adjusted',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=5, blank=True),
                      keep_default=False)

        # Deleting field 'TreeEquation.min_Z'
        db.delete_column('data_treeequation', 'min_Z')

        # Deleting field 'TreeEquation.max_Z'
        db.delete_column('data_treeequation', 'max_Z')

        # Deleting field 'TreeEquation.family'
        db.delete_column('data_treeequation', 'family')

        # Deleting field 'TreeEquation.r2_adjusted'
        db.delete_column('data_treeequation', 'r2_adjusted')

        # Deleting field 'TreeEquation.sample_size'
        db.delete_column('data_treeequation', 'sample_size')


        # Changing field 'TreeEquation.species'
        db.alter_column('data_treeequation', 'species', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'TreeEquation.genus'
        db.alter_column('data_treeequation', 'genus', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    models = {
        ...
        'data.treeequation': {
            ...
            'family': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'genus': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
