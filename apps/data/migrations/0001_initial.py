...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('data_treeequation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id_article', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('id_xls_deleted_when_ready', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('population', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('ecosystem', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ...
            ('group_location', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ...
            ('biome_FAO', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('biome_UDVARDY', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('biome_WWF', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('division_BAILEY', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('biome_HOLDRIDGE', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('temperature', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('potential_evapotranspiration', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('precipitation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('sunshine_fraction', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('wind', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('water_vapor_pressure', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('temp_MIN', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('temp_MAX', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('X', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('unit_X', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('Z', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('unit_Z', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('W', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('unit_W', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('U', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('unit_U', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('V', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('unit_V', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('min_X', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('max_X', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('min_H', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('max_H', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=8, blank=True)),
            ('output', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('output_TR', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('unit_Y', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('age', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('veg_component', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ...
            ('genus', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('species', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ...
            ('equation_y', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('n', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('top_dob', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('stump_height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('id_ref', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ...
            ('r2', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=5, blank=True)),
            ('r_adjusted', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=5, blank=True)),
            ('rmse', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=9, blank=True)),
            ('rms', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=9, blank=True)),
            ('see', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=9, blank=True)),
            ('corrected_for_bias', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('bias_correction_cf', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('data', ['TreeEquation'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('data_treeequation')
    ...
    models = {
        ...
        'data.treeequation': {
            ...
            'id_xls_deleted_when_ready': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
