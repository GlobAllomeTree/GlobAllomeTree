...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TreeEquation.family'
        db.alter_column('data_treeequation', 'family', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))
        ...
        db.alter_column('data_treeequation', 'species', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'TreeEquation.genus'
        db.alter_column('data_treeequation', 'genus', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

    def backwards(self, orm):

        # Changing field 'TreeEquation.division_BAILEY'
        db.alter_column('data_treeequation', 'division_BAILEY', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TreeEquation.location'
        db.alter_column('data_treeequation', 'location', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TreeEquation.family'
        db.alter_column('data_treeequation', 'family', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TreeEquation.biome_WWF'
        db.alter_column('data_treeequation', 'biome_WWF', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TreeEquation.biome_FAO'
        db.alter_column('data_treeequation', 'biome_FAO', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TreeEquation.population'
        db.alter_column('data_treeequation', 'population', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TreeEquation.ecosystem'
        db.alter_column('data_treeequation', 'ecosystem', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TreeEquation.biome_UDVARDY'
        db.alter_column('data_treeequation', 'biome_UDVARDY', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'TreeEquation.biome_HOLDRIDGE'
        db.alter_column('data_treeequation', 'biome_HOLDRIDGE', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
